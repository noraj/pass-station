...
## [3.0.0](https://github.com/noraj/pass-station/releases/tag/v3.0.0)
...
## [2.0.0](https://github.com/noraj/pass-station/releases/tag/v2.0.0)
...
## [1.4.0](https://github.com/noraj/pass-station/releases/tag/v1.4.0)
...
## [1.3.0](https://github.com/noraj/pass-station/releases/tag/v1.3.0)
...
## [1.2.3](https://github.com/noraj/pass-station/releases/tag/v1.2.3)
...
## [1.2.2](https://github.com/noraj/pass-station/releases/tag/v1.2.2)
...
## [1.2.1](https://github.com/noraj/pass-station/releases/tag/v1.2.1)

- fix error when empty search result
  - fix `output_search()` return value consistency

## [1.2.0](https://github.com/noraj/pass-station/releases/tag/v1.2.0)

- Fix database loading path issue [#1](https://github.com/sec-it/pass-station/issues/1)

## [1.1.0](https://github.com/noraj/pass-station/releases/tag/v1.1.0)
...
## [1.0.0](https://github.com/noraj/pass-station/releases/tag/v1.0.0)
